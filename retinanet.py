    ...
    def postprocess_detections(self, head_outputs, anchors, image_shapes):
        ...
        for index in range(num_images):
            ...
            for box_regression_per_level, logits_per_level, anchors_per_level in zip(
                ...
                num_topk = det_utils.topk_min(topk_idxs, self.topk_candidates, 0)
...
def retinanet_resnet18_fpn_v2(
        *,
        weights: Optional[str] = None,
        progress: bool = True,
        num_classes: Optional[int] = None,
        weights_backbone: Optional[ResNet18_Weights] = None,
        trainable_backbone_layers: Optional[int] = None,
        **kwargs: Any,
) -> RetinaNet:
    """
    Constructs an improved RetinaNet model with a ResNet-18-FPN backbone.
    ...
    :func:`~torchvision.models.detection.retinanet_resnet18_fpn` for more details.

    Args:
        weights (:class:`~torchvision.models.detection.RetinaNet_ResNet18_FPN_V2_Weights`, optional): The
            pretrained weights to use. See
            :class:`~torchvision.models.detection.RetinaNet_ResNet18_FPN_V2_Weights`
            below for more details, and possible values. By default, no
            pre-trained weights are used.
        progress (bool): If True, displays a progress bar of the download to stderr. Default is True.
        num_classes (int, optional): number of output classes of the model (including the background)
        weights_backbone (:class:`~torchvision.models.ResNet18_Weights`, optional): The pretrained weights for
            the backbone.
    ...
    .. autoclass:: torchvision.models.detection.RetinaNet_ResNet18_FPN_V2_Weights
        :members:
    """
    ...
    if weights_backbone:
        backbone = torch.load(weights_backbone)
